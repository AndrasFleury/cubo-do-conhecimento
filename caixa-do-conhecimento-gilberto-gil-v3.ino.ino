 ...
 *********************************************
 * Agradecimentos:
 * A minha esposa que sempre me apoia nas minhas invenções
 * Aos meus filhos que matam minhas dúvidas e ajudam
 * nas soldas além de muitas outras coisas.
 * A Fábrica de Cultura 4.0 de São Barnardo do Campo
 * por toda estrutura incrivél, aos professores maravilhos,
 * a toda equipe e cordenadores.
 *********************************************
